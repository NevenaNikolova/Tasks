...
namespace PodobniMasivi
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] numsOne = Console.ReadLine().Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
            int m = int.Parse(Console.ReadLine());
            string[] numsTwo = Console.ReadLine().Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
